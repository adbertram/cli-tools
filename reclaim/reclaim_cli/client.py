"""Reclaim client for inspecting the configured affiliate program page."""
import re
...
_client: Optional[ReclaimClient] = None


def get_client() -> ReclaimClient:
    """Get or create the global Reclaim client instance."""
    global _client
    if _client is None:
