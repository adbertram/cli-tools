"""Configuration management for Reclaim CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Reclaim — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import ReclaimBrowser
        return ReclaimBrowser(self)
