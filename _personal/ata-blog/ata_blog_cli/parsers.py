...
def parse_ata_blog_list(output: str) -> List[Dict]:
    """
    Parse wordpress list command output.
...
def parse_ata_blog_item(output: str) -> Dict:
    """
    Parse wordpress show/get command output.
