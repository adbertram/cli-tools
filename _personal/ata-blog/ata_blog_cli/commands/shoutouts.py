...
app.add_typer(site_shoutout.app, name="site")
...
def _sponsors_file_path() -> Path:
    return Path(get_config().sponsors_file)
...
def list_shoutouts(
    ...
    sponsor: Optional[str] = typer.Option(None, "--sponsor", help="Sponsor name from the sponsor registry (ATABLOGGER_SPONSORS_FILE in the ata-blog config)"),
