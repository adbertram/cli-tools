"""Configuration management for Legoscout CLI wrapper."""
...
class Config(BaseConfig):
    """Configuration manager for Legoscout CLI wrapper."""

    DIST_NAME = "legoscout-cli"
    CREDENTIAL_TYPES = []
    DEFAULT_BASE_URL = ""
    ...
    def cli_command(self) -> str:
        ...
        return self._get("CLI_COMMAND") or "python3"
