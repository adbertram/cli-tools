...
from .commands import auth, channel, channels, shorts, transcripts, videos
...
register_commands(app, get_config, shorts, name="shorts", help="Upload YouTube Shorts through the existing Data API uploader")
