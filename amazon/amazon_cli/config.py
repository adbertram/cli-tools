"""Configuration management for Amazon CLI (browser automation).
...
class Config(BaseConfig):
    """Configuration for Amazon — extends BaseConfig for shared auth/profile support."""

    DIST_NAME = "amazon-cli"

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://www.amazon.com"
