"""Microsoft365 client using shared browser session tooling."""
    ...
    def _browser_http_client(self) -> BrowserAuthenticatedHttpClient:
        ...
        if self._http_client is None:
            self._http_client = BrowserAuthenticatedHttpClient(
                ...
                allowed_domains=["www.microsoft.com", "microsoft.com"],
                timeout=10,
            )
...
_client: Optional[Microsoft365Client] = None


def get_client() -> Microsoft365Client:
    """Get or create the global Microsoft365 client instance."""
    global _client
    if _client is None:
        _client = Microsoft365Client()
    return _client
