"""Configuration management for Microsoft365 CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Microsoft365 — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import Microsoft365Browser
        return Microsoft365Browser(self)
