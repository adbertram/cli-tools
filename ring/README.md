...
The CLI installs itself when scaffolded via `~/.claude/skills/cli-tool/scripts/new-cli-tool`. To reinstall manually:

```bash
~/.claude/skills/cli-tool/scripts/install-cli-tool.sh ring
```
