"""Configuration management for MetaBox CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for MetaBox — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import MetaBoxBrowser
        return MetaBoxBrowser(self)
