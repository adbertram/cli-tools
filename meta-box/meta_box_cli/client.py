"""MetaBox client using shared browser session tooling."""
...
class MetaBoxClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for MetaBox")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for MetaBox")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for MetaBox")


_client: Optional[MetaBoxClient] = None


def get_client() -> MetaBoxClient:
    """Get or create the global MetaBox client instance."""
    global _client
    if _client is None:
        _client = MetaBoxClient()
    return _client
