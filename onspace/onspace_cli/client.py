"""Onspace client using shared browser session tooling."""
...
class OnspaceClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Onspace")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Onspace")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Onspace")


_client: Optional[OnspaceClient] = None


def get_client() -> OnspaceClient:
    """Get or create the global Onspace client instance."""
    global _client
    if _client is None:
        _client = OnspaceClient()
    return _client
