"""Configuration management for Onspace CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Onspace — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import OnspaceBrowser
        return OnspaceBrowser(self)
