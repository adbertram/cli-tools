"""Namecheap client using shared browser session tooling."""
...
class NamecheapClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Namecheap")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Namecheap")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Namecheap")


_client: Optional[NamecheapClient] = None


def get_client() -> NamecheapClient:
    """Get or create the global Namecheap client instance."""
    global _client
    if _client is None:
