"""Configuration management for Namecheap CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Namecheap — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import NamecheapBrowser
        return NamecheapBrowser(self)
