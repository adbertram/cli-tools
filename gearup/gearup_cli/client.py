"""Gearup client using shared browser session tooling."""
...
class GearupClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Gearup")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Gearup")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Gearup")


_client: Optional[GearupClient] = None


def get_client() -> GearupClient:
    """Get or create the global Gearup client instance."""
    global _client
    if _client is None:
        _client = GearupClient()
    return _client
