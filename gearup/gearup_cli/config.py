"""Configuration management for Gearup CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Gearup — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import GearupBrowser
        return GearupBrowser(self)
