"""Dell client for inspecting the configured affiliate program page."""
import re
...
_client: Optional[DellClient] = None


def get_client() -> DellClient:
    """Get or create the global Dell client instance."""
    global _client
    if _client is None:
        _client = DellClient()
    return _client
