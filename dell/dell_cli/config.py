"""Configuration management for Dell CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Dell — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import DellBrowser
        return DellBrowser(self)
