"""Configuration management for Make.com CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Make.com using shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import MakecomBrowser
        return MakecomBrowser(self)
