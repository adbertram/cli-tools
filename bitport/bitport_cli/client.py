"""Bitport client using shared browser session tooling."""
...
class BitportClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Bitport")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Bitport")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Bitport")


_client: Optional[BitportClient] = None


def get_client() -> BitportClient:
    """Get or create the global Bitport client instance."""
    global _client
    if _client is None:
        _client = BitportClient()
    return _client
