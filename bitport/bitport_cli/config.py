"""Configuration management for Bitport CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Bitport — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import BitportBrowser
        return BitportBrowser(self)
