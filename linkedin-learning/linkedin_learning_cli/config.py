"""Configuration management for LinkedinLearning CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for LinkedinLearning — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import LinkedinLearningBrowser
        return LinkedinLearningBrowser(self)
