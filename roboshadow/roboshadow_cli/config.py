"""Configuration management for Roboshadow CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Roboshadow — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import RoboshadowBrowser
        return RoboshadowBrowser(self)
