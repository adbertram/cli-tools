"""Roboshadow client using shared browser session tooling."""
...
class RoboshadowClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Roboshadow")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Roboshadow")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Roboshadow")


_client: Optional[RoboshadowClient] = None


def get_client() -> RoboshadowClient:
    """Get or create the global Roboshadow client instance."""
    global _client
    if _client is None:
        _client = RoboshadowClient()
    return _client
