"""Configuration management for TunnelBear CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for TunnelBear — extends BaseConfig for shared auth/profile support."""

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://www.tunnelbear.com/"
    DIST_NAME = "tunnelbear-cli"
    SESSION_NAME = "tunnelbear"
    LOGIN_URL = "https://www.tunnelbear.com/"
    ...
    def get_browser(self):
        ...
        from .browser import TunnelbearBrowser
        return TunnelbearBrowser(self)
