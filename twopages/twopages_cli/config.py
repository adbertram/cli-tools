"""Configuration management for Twopages CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Twopages — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import TwopagesBrowser
        return TwopagesBrowser(self)
