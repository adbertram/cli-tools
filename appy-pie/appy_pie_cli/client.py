"""AppyPie client using shared browser session tooling."""
...
class AppyPieClient:
    ...
    PRODUCT_NAME = "Appy Pie"
    RECORD_ID = "rec6VXtztQznnhabC"
    ...
    def _browser_http_client(self) -> BrowserAuthenticatedHttpClient:
        ...
        if self._http_client is None:
            self._http_client = BrowserAuthenticatedHttpClient(
                ...
                allowed_domains=["www.appypie.com", "appypie.com"],
                timeout=10,
            )
...
_client: Optional[AppyPieClient] = None


def get_client() -> AppyPieClient:
    """Get or create the global AppyPie client instance."""
    global _client
    if _client is None:
        _client = AppyPieClient()
    return _client
