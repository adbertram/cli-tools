...
def parse_imessage_list(output: str) -> List[Dict]:
    """
    Parse osascript list command output.
...
def parse_imessage_item(output: str) -> Dict:
    """
    Parse osascript show/get command output.
