"""Configuration management for Imessage CLI wrapper."""
import os
import shutil
...
class Config(BaseConfig):
    """Configuration manager for Imessage CLI wrapper."""

    CREDENTIAL_TYPES: list = []  # custom field set; managed by this subclass
    DIST_NAME = "imessage-cli"
    ...
    def cli_command(self) -> str:
        ...
        return os.getenv("IMESSAGE_CLI_COMMAND", "osascript")

    @property
    def cli_path(self) -> Optional[str]:
        """Get optional full path to CLI executable."""
        return os.getenv("IMESSAGE_CLI_PATH")
