"""Configuration management for Pluralsight CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Pluralsight — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import PluralsightBrowser
        return PluralsightBrowser(self)
