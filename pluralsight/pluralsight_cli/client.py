"""Pluralsight client using shared browser session tooling."""
...
class PluralsightClient:
    ...
    PRODUCT_NAME = "Pluralsight"
    RECORD_ID = "rec0unlMqDMS2Jr1E"
    ...
    def _browser_http_client(self) -> BrowserAuthenticatedHttpClient:
        ...
        if self._http_client is None:
            self._http_client = BrowserAuthenticatedHttpClient(
                ...
                allowed_domains=["www.pluralsight.com", "pluralsight.com"],
                timeout=10,
            )
