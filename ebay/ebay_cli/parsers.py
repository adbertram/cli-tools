"""Output parsing utilities for eBay CLI."""
...
def format_local_time_only(timestamp: str) -> str:
    """Convert an ISO timestamp to local time only (e.g., "14:30:45").
...
def format_date(timestamp: str) -> str:
    """Convert an ISO timestamp to a local date string (e.g., "Jan 13, 2025").
    ...
    """
    return format_local_time(timestamp, '%b %d, %Y')
