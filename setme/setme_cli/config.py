"""Configuration management for Setme CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Setme — extends BaseConfig for shared auth/profile support."""

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://www.setme.net/"
    DIST_NAME = "setme-cli"
    SESSION_NAME = "setme"
    ...
    def get_browser(self):
        ...
        from .browser import SetmeBrowser
        return SetmeBrowser(self)
