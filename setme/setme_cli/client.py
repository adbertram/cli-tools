"""Setme client using shared browser session tooling."""
...
class SetmeClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Setme")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Setme")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Setme")


_client: Optional[SetmeClient] = None


def get_client() -> SetmeClient:
    """Get or create the global Setme client instance."""
    global _client
    if _client is None:
        _client = SetmeClient()
    return _client
