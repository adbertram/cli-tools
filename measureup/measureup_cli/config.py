"""Configuration management for MeasureUp CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for MeasureUp — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import MeasureupBrowser
        return MeasureupBrowser(self)
