"""Configuration management for Nvidia CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Nvidia — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import NvidiaBrowser
        return NvidiaBrowser(self)
