...
def parse_cliclick_list(output: str) -> List[Dict]:
    """
    Parse cliclick list command output.
...
def parse_cliclick_item(output: str) -> Dict:
    """
    Parse cliclick show/get command output.
