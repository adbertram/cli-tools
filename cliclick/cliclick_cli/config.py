...
class Config(BaseConfig):
    ...
    CUSTOM_ALL_FIELDS = ["CLICLICK_CLI_COMMAND", "CLICLICK_CLI_PATH"]
    CUSTOM_EPHEMERAL_FIELDS = []

    def __init__(self, profile=None):
        """Initialize configuration by loading from the selected profile."""
        super().__init__(
    ...
    def cli_command(self) -> str:
        ...
        return os.getenv("CLICLICK_CLI_COMMAND", "cliclick")

    @property
    def cli_path(self) -> Optional[str]:
        """Get optional full path to CLI executable."""
        return os.getenv("CLICLICK_CLI_PATH")
