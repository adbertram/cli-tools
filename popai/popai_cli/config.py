"""Configuration management for Popai CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Popai — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import PopaiBrowser
        return PopaiBrowser(self)
