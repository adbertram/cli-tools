"""Popai client using shared browser session tooling."""
...
class PopaiClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Popai")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Popai")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Popai")


_client: Optional[PopaiClient] = None


def get_client() -> PopaiClient:
    """Get or create the global Popai client instance."""
    global _client
    if _client is None:
        _client = PopaiClient()
    return _client
