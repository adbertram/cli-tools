"""Configuration management for Offerup CLI (browser automation).
...
class Config(BaseConfig):
    """Configuration for Offerup — extends BaseConfig for shared auth/profile support."""

    DIST_NAME = "offerup-cli"

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://offerup.com"
    ...
    def get_browser(self):
        ...
        from .browser import OfferupBrowser
        return OfferupBrowser(self)

    def test_connection(self) -> dict:
        """Live browser-session verification used by `offerup auth test`."""
