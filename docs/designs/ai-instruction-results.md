...
**`/Users/adam/Dropbox/GitRepos/cli-tools/cli-tools-shared/cli_tools_shared/models.py`** - modified
...
**`/Users/adam/Dropbox/GitRepos/cli-tools/cli-tools-shared/cli_tools_shared/output.py`** - modified
...
**`/Users/adam/Dropbox/GitRepos/cli-tools/cli-tools-shared/cli_tools_shared/__init__.py`** - modified
...
**`/Users/adam/Dropbox/GitRepos/cli-tools/cli-tools-shared/tests/test_ai_instruction_results.py`** - created
...
**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/api/{{name}}_cli/output.py`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/api/{{name}}_cli/output.py`** - modified
Rationale: Mirror the API output helper re-export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/browser/{{name}}_cli/output.py`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/browser/{{name}}_cli/output.py`** - modified
Rationale: Mirror the browser output helper re-export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/wrapper/{{name}}_cli/output.py`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/wrapper/{{name}}_cli/output.py`** - modified
Rationale: Mirror the wrapper output helper re-export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/api/{{name}}_cli/models/ai_instruction.py`** - created
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/api/{{name}}_cli/models/ai_instruction.py`** - created
Rationale: Mirror the API model re-export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/browser/{{name}}_cli/models/ai_instruction.py`** - created
Rationale: Same as the API template model file, scoped to browser tools.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/browser/{{name}}_cli/models/ai_instruction.py`** - created
Rationale: Mirror the browser model re-export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/wrapper/{{name}}_cli/models/ai_instruction.py`** - created
Rationale: Same as the API template model file, scoped to wrapper tools.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/wrapper/{{name}}_cli/models/ai_instruction.py`** - created
Rationale: Mirror the wrapper model re-export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/api/{{name}}_cli/models/__init__.py`** - modified
Rationale: Export `AIInstruction` from generated API model packages.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/api/{{name}}_cli/models/__init__.py`** - modified
Rationale: Mirror the API model package export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/browser/{{name}}_cli/models/__init__.py`** - modified
Rationale: Export `AIInstruction` from generated browser model packages.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/browser/{{name}}_cli/models/__init__.py`** - modified
Rationale: Mirror the browser model package export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/wrapper/{{name}}_cli/models/__init__.py`** - modified
Rationale: Export `AIInstruction` from generated wrapper model packages.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/wrapper/{{name}}_cli/models/__init__.py`** - modified
Rationale: Mirror the wrapper model package export for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/references/output-standards.md`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/references/output-standards.md`** - modified
Rationale: Mirror the output standard for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/references/model-standards.md`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/references/model-standards.md`** - modified
Rationale: Mirror the model standard for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/references/templates.md`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/references/templates.md`** - modified
Rationale: Mirror the template guidance for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/api/README.md`** - modified
Rationale: Add author-facing documentation for returning AI instruction results from generated API CLIs.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/api/README.md`** - modified
Rationale: Mirror the generated API README guidance for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/browser/README.md`** - modified
Rationale: Add author-facing documentation for returning AI instruction results from generated browser CLIs.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/browser/README.md`** - modified
Rationale: Mirror the generated browser README guidance for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/templates/wrapper/README.md`** - modified
Rationale: Add author-facing documentation for returning AI instruction results from generated wrapper CLIs.

**`/Users/adam/Dropbox/.claude/skills/cli-tool/templates/wrapper/README.md`** - modified
Rationale: Mirror the generated wrapper README guidance for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/create-cli-tool-skill/templates/SKILL.md.template`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/create-cli-tool-skill/templates/SKILL.md.template`** - modified
...
**`/Users/adam/Dropbox/.agents/skills/create-cli-tool-skill/SKILL.md`** - modified
Rationale: Document AI instruction result awareness as a core generated CLI skill standard.

**`/Users/adam/Dropbox/.claude/skills/create-cli-tool-skill/SKILL.md`** - modified
Rationale: Mirror the generated CLI skill standard for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/create-cli-tool-skill/references/json-schema.md`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/create-cli-tool-skill/references/json-schema.md`** - modified
Rationale: Mirror the schema-guide update for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/create-cli-tool-skill/scripts/validate-usage-json.sh`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/create-cli-tool-skill/scripts/validate-usage-json.sh`** - modified
Rationale: Mirror the validator change for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/SKILL.md`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/SKILL.md`** - modified
Rationale: Mirror the CLI-tool skill standard for Claude Code parity.

**`/Users/adam/Dropbox/.agents/skills/cli-tool/scripts/validate-cli-tool.sh`** - modified
...
**`/Users/adam/Dropbox/.claude/skills/cli-tool/scripts/validate-cli-tool.sh`** - modified
Rationale: Mirror the CLI validator change for Claude Code parity if the Claude skill bundle carries the same script.

**`/Users/adam/Dropbox/GitRepos/cli-tools/docs/designs/ai-instruction-results.md`** - created
