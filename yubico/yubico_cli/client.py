"""Yubico client using shared browser session tooling."""
...
class YubicoClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Yubico")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Yubico")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Yubico")


_client: Optional[YubicoClient] = None


def get_client() -> YubicoClient:
    """Get or create the global Yubico client instance."""
    global _client
    if _client is None:
        _client = YubicoClient()
    return _client
