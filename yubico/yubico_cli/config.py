"""Configuration management for Yubico CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Yubico — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import YubicoBrowser
        return YubicoBrowser(self)
