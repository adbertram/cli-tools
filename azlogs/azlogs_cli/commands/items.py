...
app = typer.Typer(help="Manage azlogs items", no_args_is_help=True)
...
def items_list(
    ...
    Examples:
        azlogs items list
        azlogs items list --table
        azlogs items list --limit 10
        azlogs items list --filter "status:active"
        azlogs items list --properties "id,name"
        azlogs items list --properties "id,user.name,status"
    """
    try:
        client = get_client()
...
def items_get(
    ...
    Examples:
        azlogs items get ITEM_ID
        azlogs items get ITEM_ID --table
        azlogs items get ITEM_ID --properties "id,name"
        azlogs items get ITEM_ID --properties "user.name,user.email"
    """
    try:
        client = get_client()
...
def items_search(
    ...
    Examples:
        azlogs items search "*invoice*"
        azlogs items search "INV-2024*"
        azlogs items search "*pending*" --fields "status,notes"
        azlogs items search "*error*" --properties "id,name,status" --table
    """
    try:
        client = get_client()
