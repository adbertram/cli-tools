...
def parse_notifier_list(output: str) -> List[Dict]:
    """
    Parse terminal-notifier list command output.
...
def parse_notifier_item(output: str) -> Dict:
    """
    Parse terminal-notifier show/get command output.
