"""Configuration management for Notifier CLI wrapper."""
import os
import shutil
...
class Config(BaseConfig):
    """Configuration manager for Notifier CLI wrapper."""

    CREDENTIAL_TYPES: list = []  # custom field set; managed by this subclass
    DIST_NAME = "notifier-cli"
    ...
    def cli_command(self) -> str:
        ...
        return os.getenv("NOTIFIER_CLI_COMMAND", "terminal-notifier")

    @property
    def cli_path(self) -> Optional[str]:
        """Get optional full path to CLI executable."""
        return os.getenv("NOTIFIER_CLI_PATH")
