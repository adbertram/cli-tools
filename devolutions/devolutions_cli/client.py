"""Devolutions client using shared browser session tooling."""
...
class DevolutionsClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Devolutions")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Devolutions")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Devolutions")


_client: Optional[DevolutionsClient] = None


def get_client() -> DevolutionsClient:
    """Get or create the global Devolutions client instance."""
    global _client
    if _client is None:
        _client = DevolutionsClient()
    return _client
