"""Configuration management for Devolutions CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Devolutions — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import DevolutionsBrowser
        return DevolutionsBrowser(self)
