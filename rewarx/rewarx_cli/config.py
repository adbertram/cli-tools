"""Configuration management for Rewarx CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Rewarx — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import RewarxBrowser
        return RewarxBrowser(self)
