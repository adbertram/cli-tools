...
<quick_start>
Use these commands to get BrickStore price guide data, catalog data, set contents, and database metadata:
```bash
...
`set-contents` reads the local database. It does not call the BrickLink CLI or the BrickLink API.
