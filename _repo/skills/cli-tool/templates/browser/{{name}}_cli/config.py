"""Configuration management for {{Name}} CLI (browser automation).
...
class Config(BaseConfig):
    """Configuration for {{Name}} — extends BaseConfig for shared auth/profile support."""
