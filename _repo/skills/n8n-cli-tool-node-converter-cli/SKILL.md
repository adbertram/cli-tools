...
description: "Use this skill for service operations only. DO NOT use this skill for CLI implementation lifecycle work such as creating, testing, updating, troubleshooting, validating, removing, or documenting the CLI tool itself; delegate those tasks to cli-tool-expert. MANDATORY: Execute n8n-cli-tool-node-converter operations using the `n8n-cli-tool-node-converter` CLI tool. Convert standardized CLI tools into n8n community node packages. Triggers: n8n-cli-tool-node-converter, n8n node converter, convert cli to n8n, generate n8n node, n8n community node, cli to n8n node"
---
...
**MANDATORY: Consult `usage.json` before executing ANY `n8n-cli-tool-node-converter` command.**
