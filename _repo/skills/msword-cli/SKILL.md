...
```bash
msword docs <read|convert> <file> [options]
msword docs comments <list|get|add> ...
```
...
| Get one comment | `msword docs comments get document.docx 0 --table` |
| Filter comments by author | `msword docs comments list document.docx --filter "author:eq:Jane"` |
...
- **docs** -- Read, convert, and manage comments in Word documents (read, convert, comments {list, get, add})
</principle>
</essential_principles>
