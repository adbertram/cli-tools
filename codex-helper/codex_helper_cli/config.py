"""Configuration management for CodexHelper CLI wrapper."""
...
class Config(BaseConfig):
    """Configuration manager for CodexHelper CLI wrapper."""

    DIST_NAME = "codex-helper-cli"
    CREDENTIAL_TYPES = []
    DEFAULT_BASE_URL = ""
    ...
    def cli_command(self) -> str:
        ...
        return self._get("CLI_COMMAND") or "codex"
