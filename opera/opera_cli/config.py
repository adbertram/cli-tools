"""Configuration management for Opera CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Opera — extends BaseConfig for shared auth/profile support."""

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://www.opera.com/opera/affiliate"
    DIST_NAME = "opera-cli"
    SESSION_NAME = "opera"
    ...
    def get_browser(self):
        ...
        from .browser import OperaBrowser
        return OperaBrowser(self)
