"""Opera client using shared browser session tooling."""
...
class OperaClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Opera")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Opera")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Opera")


_client: Optional[OperaClient] = None


def get_client() -> OperaClient:
    """Get or create the global Opera client instance."""
    global _client
    if _client is None:
        _client = OperaClient()
    return _client
