"""Quartile client using shared browser session tooling."""
...
class QuartileClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Quartile")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Quartile")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Quartile")


_client: Optional[QuartileClient] = None


def get_client() -> QuartileClient:
    """Get or create the global Quartile client instance."""
    global _client
    if _client is None:
        _client = QuartileClient()
    return _client
