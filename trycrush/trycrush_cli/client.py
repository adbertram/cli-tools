"""Trycrush client using shared browser session tooling."""
...
class TrycrushClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Trycrush")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Trycrush")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Trycrush")


_client: Optional[TrycrushClient] = None


def get_client() -> TrycrushClient:
    """Get or create the global Trycrush client instance."""
    global _client
    if _client is None:
        _client = TrycrushClient()
    return _client
