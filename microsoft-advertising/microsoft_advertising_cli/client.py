"""Microsoft Advertising client for inspecting the configured affiliate program page."""
import re
...
_client: Optional[MicrosoftAdvertisingClient] = None


def get_client() -> MicrosoftAdvertisingClient:
    """Get or create the global MicrosoftAdvertising client instance."""
    global _client
    if _client is None:
        _client = MicrosoftAdvertisingClient()
    return _client
