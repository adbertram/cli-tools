"""Search commands for MicrosoftAdvertising CLI."""
COMMAND_CREDENTIALS = {
...
app = typer.Typer(help="Search MicrosoftAdvertising", no_args_is_help=True)
...
def search_query(
    ...
    """
    Search for items on MicrosoftAdvertising.

    Example:
        microsoft-advertising search query "my search term" --limit 20 --table
        microsoft-advertising search query "keyword" --filter "price:lt:100"
        microsoft-advertising search query "keyword" --properties "title,price"
    """
    try:
...
def search_item(
    ...
    Example:
        microsoft-advertising search item abc123 --table
        microsoft-advertising search item "https://example.com/item/abc123"
        microsoft-advertising search item abc123 --properties "title,price"
    """
    try:
        client = get_client()
...
def search_list(
    ...
    """
    List items from MicrosoftAdvertising.

    Example:
        microsoft-advertising search list --limit 100 --table
        microsoft-advertising search list --filter "status:active"
        microsoft-advertising search list --properties "id,name,status"
    """
    try:
        # Validate filters if provided
        if filter:
...
def search_wildcard(
    ...
    Examples:
        microsoft-advertising search wildcard "*test*"
        microsoft-advertising search wildcard "prefix*"
        microsoft-advertising search wildcard "*pending*" --fields "status,notes"
        microsoft-advertising search wildcard "*error*" --properties "id,name,status" --table
    """
    try:
        client = get_client()
