"""Modello Turbo client for inspecting the configured affiliate program page."""
import re
...
_client: Optional[ModelloTurboClient] = None


def get_client() -> ModelloTurboClient:
    """Get or create the global ModelloTurbo client instance."""
    global _client
    if _client is None:
        _client = ModelloTurboClient()
    return _client
