"""Configuration management for ModelloTurbo CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for ModelloTurbo — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import ModelloTurboBrowser
        return ModelloTurboBrowser(self)
