"""Configuration management for Pipedrive CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Pipedrive — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import PipedriveBrowser
        return PipedriveBrowser(self)
