"""Configuration management for Plusmetrica CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Plusmetrica — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import PlusmetricaBrowser
        return PlusmetricaBrowser(self)
