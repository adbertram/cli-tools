"""Plusmetrica client using shared browser session tooling."""
...
class PlusmetricaClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Plusmetrica")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Plusmetrica")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Plusmetrica")


_client: Optional[PlusmetricaClient] = None


def get_client() -> PlusmetricaClient:
    """Get or create the global Plusmetrica client instance."""
    global _client
    if _client is None:
        _client = PlusmetricaClient()
    return _client
