...
def parse_photos_app_list(output: str) -> List[Dict]:
    """
    Parse sqlite3 list command output.
...
def parse_photos_app_item(output: str) -> Dict:
    """
    Parse sqlite3 show/get command output.
