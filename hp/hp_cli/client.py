"""Hp client using shared browser session tooling."""
...
class HpClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Hp")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Hp")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Hp")


_client: Optional[HpClient] = None


def get_client() -> HpClient:
    """Get or create the global Hp client instance."""
    global _client
    if _client is None:
        _client = HpClient()
    return _client
