"""Configuration management for Hp CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Hp — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import HpBrowser
        return HpBrowser(self)
