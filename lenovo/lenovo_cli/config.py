"""Configuration management for Lenovo CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Lenovo — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import LenovoBrowser
        return LenovoBrowser(self)
