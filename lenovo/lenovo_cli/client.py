"""Lenovo client using shared browser session tooling."""
...
class LenovoClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Lenovo")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Lenovo")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Lenovo")


_client: Optional[LenovoClient] = None


def get_client() -> LenovoClient:
    """Get or create the global Lenovo client instance."""
    global _client
    if _client is None:
        _client = LenovoClient()
    return _client
