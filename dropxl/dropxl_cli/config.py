"""Configuration management for Dropxl CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Dropxl — extends BaseConfig for shared auth/profile support."""

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://www.dropxl.com/homepage.html"
    DIST_NAME = "dropxl-cli"
    SESSION_NAME = "dropxl"
    ...
    def get_browser(self):
        ...
        from .browser import DropxlBrowser
        return DropxlBrowser(self)
