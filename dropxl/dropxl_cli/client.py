"""Dropxl client using shared browser session tooling."""
...
class DropxlClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Dropxl")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Dropxl")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Dropxl")


_client: Optional[DropxlClient] = None


def get_client() -> DropxlClient:
    """Get or create the global Dropxl client instance."""
    global _client
    if _client is None:
        _client = DropxlClient()
    return _client
