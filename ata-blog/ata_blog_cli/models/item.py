...
def create_item(data: dict) -> Item:
    """Create an Item model from CLI output data.

    Args:
        data: Raw dict from CLI output parsing
...
def create_item_detail(data: dict) -> ItemDetail:
    """Create an ItemDetail model from CLI output data.
