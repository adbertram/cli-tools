...
import typer
from cli_tools_shared.filters import exact_session_ids
...
SESSION_COLUMNS = ["id", "name", "project", "last_activity", "model", "message_count", "tool_call_count", "has_errors"]
SESSION_HEADERS = ["ID", "Name", "Project", "Last Activity", "Model", "Messages", "Tools", "Errors"]
