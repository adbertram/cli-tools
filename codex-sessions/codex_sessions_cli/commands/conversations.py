...
CONVERSATION_COLUMNS = ["id", "project", "conversation_id", "last_activity", "model", "message_count", "tool_call_count"]
CONVERSATION_HEADERS = ["ID", "Project", "Conversation", "Last Activity", "Model", "Messages", "Tools"]
