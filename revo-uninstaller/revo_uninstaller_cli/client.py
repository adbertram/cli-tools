"""Revo Uninstaller client for inspecting the configured affiliate program page."""
import re
...
_client: Optional[RevoUninstallerClient] = None


def get_client() -> RevoUninstallerClient:
    """Get or create the global RevoUninstaller client instance."""
    global _client
    if _client is None:
        _client = RevoUninstallerClient()
    return _client
