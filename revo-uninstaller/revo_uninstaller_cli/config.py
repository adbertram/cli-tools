"""Configuration management for RevoUninstaller CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for RevoUninstaller — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import RevoUninstallerBrowser
        return RevoUninstallerBrowser(self)
