"""Wegic client using shared browser session tooling."""
...
class WegicClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Wegic")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Wegic")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Wegic")


_client: Optional[WegicClient] = None


def get_client() -> WegicClient:
    """Get or create the global Wegic client instance."""
    global _client
    if _client is None:
        _client = WegicClient()
    return _client
