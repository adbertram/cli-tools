"""Configuration management for Wegic CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Wegic — extends BaseConfig for shared auth/profile support."""

    CREDENTIAL_TYPES = [CredentialType.BROWSER_SESSION]
    DEFAULT_BASE_URL = "https://wegic.ai/"
    DIST_NAME = "wegic-cli"
    SESSION_NAME = "wegic"
    ...
    def get_browser(self):
        ...
        from .browser import WegicBrowser
        return WegicBrowser(self)
