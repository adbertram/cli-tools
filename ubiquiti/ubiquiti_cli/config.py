"""Configuration management for Ubiquiti CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Ubiquiti — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import UbiquitiBrowser
        return UbiquitiBrowser(self)
