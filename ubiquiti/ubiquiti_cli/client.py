"""Ubiquiti client for inspecting the configured affiliate program page."""
import re
...
_client: Optional[UbiquitiClient] = None


def get_client() -> UbiquitiClient:
    """Get or create the global Ubiquiti client instance."""
    global _client
    if _client is None:
        _client = UbiquitiClient()
    return _client
