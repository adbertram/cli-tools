"""Configuration management for Ship7 CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for Ship7 — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import Ship7Browser
        return Ship7Browser(self)
