"""Ship7 client using shared browser session tooling."""
...
class Ship7Client:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for Ship7")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for Ship7")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for Ship7")


_client: Optional[Ship7Client] = None


def get_client() -> Ship7Client:
    """Get or create the global Ship7 client instance."""
    global _client
    if _client is None:
        _client = Ship7Client()
    return _client
