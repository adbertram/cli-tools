---
name: "n8n-node-cli"
description: "Use this skill for service operations only. DO NOT use this skill for CLI implementation lifecycle work such as creating, testing, updating, troubleshooting, validating, removing, or documenting the CLI tool itself; delegate those tasks to cli-tool-expert. MANDATORY: Execute n8n-node operations using the `n8n-node` CLI tool. Manage n8n community node packages -- convert CLI tools, deploy to adam-server, test nodes, manage credentials, and query logs. Triggers: n8n-node, n8n node, n8n node cli, convert cli to n8n node, deploy n8n node, test n8n node, n8n credentials, n8n logs, n8n executions, n8n community node"
---
...
**MANDATORY: Consult `usage.json` before executing ANY `n8n-node` command.**
