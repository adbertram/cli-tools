...
```bash
ls <cli-tools-root>/skills/<tool>-cli/usage.json
```
...
Read both files:
- Existing: `<cli-tools-root>/skills/<tool>-cli/usage.json`
...
Write merged result to `<cli-tools-root>/skills/<tool>-cli/usage.json`.
