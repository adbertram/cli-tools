...
```bash
<cli-tools-root>/skills/cli-tool/scripts/remove-cli-tool.sh "<name>"
```

## Step 4: Update cli_tools.md

Edit `<cli-tools-root>/docs/cli_tools.md` to remove the table row for `<name>` from the CLI tools table.
