...
LOCAL_SHARED_DIR="$CLI_TOOLS_DIR/cli-tools-shared"
...
# cli-tools-shared/tests/test_no_venv_in_cli_tool_sources.py defines the
...
INSTALL_OUTPUT=$(uv tool install -e "$TOOL_DIR" --force --refresh "${PY_FLAG[@]}" 2>&1)
INSTALL_EXIT=$?
