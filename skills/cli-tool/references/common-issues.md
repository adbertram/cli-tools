...
```bash
<cli-tools-root>/skills/cli-tool/scripts/install-cli-tool.sh myservice
```
...
<cli-tools-root>/skills/cli-tool/scripts/test-cli-tool.sh --cli-name <cli>  # both tests pass
```
...
# Full test suite
<cli-tools-root>/skills/cli-tool/scripts/test-cli-tool.sh myservice
```
