---
name: "azlogs-cli"
description: "Use this skill for service operations only. DO NOT use this skill for CLI implementation lifecycle work such as creating, testing, updating, troubleshooting, validating, removing, or documenting the CLI tool itself; delegate those tasks to cli-tool-expert. MANDATORY: Execute azlogs operations using the `azlogs` CLI tool. Download, parse, and analyze Azure Web App logs via Kudu API. Triggers: azlogs, azlogs cli, azure logs, azure web app logs, download azure logs, query log entries, azlogs packages, azlogs entries, log analysis report, kudu logs"
---
