...
register_commands(app, get_config, environments, name="environments", help="Manage demo environment records")
register_commands(app, get_config, slides, name="slides", help="Manage slide records")
app.add_typer(voice_recordings.app, name="voice-recordings", help="Generate slide and demo voice recordings")
app.add_typer(templates.app, name="slide-templates", help="Manage slide template records")
