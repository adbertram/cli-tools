"""MartinicAudio client using shared browser session tooling."""
...
class MartinicAudioClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for MartinicAudio")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for MartinicAudio")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for MartinicAudio")


_client: Optional[MartinicAudioClient] = None


def get_client() -> MartinicAudioClient:
    """Get or create the global MartinicAudio client instance."""
    global _client
    if _client is None:
        _client = MartinicAudioClient()
    return _client
