"""Configuration management for MartinicAudio CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for MartinicAudio — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import MartinicAudioBrowser
        return MartinicAudioBrowser(self)
