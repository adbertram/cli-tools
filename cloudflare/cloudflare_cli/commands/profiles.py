"""Profiles commands for Cloudflare CLI with standard list flags."""
import typer
from typing import Optional, List

from cli_tools_shared.filters import FilterValidationError, apply_filters, validate_filters
from cli_tools_shared.output import print_json, print_table, print_error, print_success, print_info, command
