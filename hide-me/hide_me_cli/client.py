"""HideMe client using shared browser session tooling."""
...
class HideMeClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for HideMe")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for HideMe")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for HideMe")


_client: Optional[HideMeClient] = None


def get_client() -> HideMeClient:
    """Get or create the global HideMe client instance."""
    global _client
    if _client is None:
        _client = HideMeClient()
    return _client
