"""Configuration management for HideMe CLI (browser automation)."""
...
class Config(BaseConfig):
    """Configuration for HideMe — extends BaseConfig for shared auth/profile support."""
    ...
    def get_browser(self):
        ...
        from .browser import HideMeBrowser
        return HideMeBrowser(self)
