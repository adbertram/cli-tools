...
A command-line interface for [HideMe](https://hide.me/en/affiliate) using browser automation. Browser CLI for hide.me affiliate workflows
...
After installation, the `hide-me` command will be available in your terminal.
...
# Search for items
hide-me search query "search terms"

# Get item details
hide-me search item ITEM_ID
```

## Commands

### Authentication (`hide-me auth`)
...
hide-me auth login --profile work

# Use named profile for status check
hide-me auth status --profile work

# Set default profile via environment variable
export HIDE_ME_DEFAULT_PROFILE=work
hide-me auth status  # Uses 'work' profile

# Logout specific profile
hide-me auth logout --profile work
...
### Profiles (`hide-me auth profiles`)

```bash
# List all profiles
hide-me auth profiles list

# Show default profile
hide-me auth profiles get default

# Switch default profile
hide-me auth profiles set-default PROFILE_NAME

# Create a new profile
hide-me auth profiles create PROFILE_NAME
```
...
```bash
# Show cache status
hide-me cache status

# Clear cached responses
hide-me cache clear
```

### Search (`hide-me search`)
...
# Limit results
hide-me search query "search terms" --limit 10

# Get item details
hide-me search item ITEM_ID
hide-me search item https://example.com/item/123
...
HIDE_ME_USERNAME=your_username
HIDE_ME_PASSWORD=your_password

# Base URL
HIDE_ME_BASE_URL=https://hide.me/en/affiliate

# Browser settings (true = invisible, false = visible browser)
HIDE_ME_HEADLESS=true

# Authentication Configuration
HIDE_ME_AUTH_COOKIE_NAMES=session.*,auth,token,sid  # Regex patterns for auth cookies
HIDE_ME_AUTH_SELECTOR=                               # CSS selector indicating authenticated state
HIDE_ME_AUTH_URL_PATTERN=                            # URL pattern indicating login page
HIDE_ME_AUTH_TIMEOUT=60                              # Seconds to wait for login
HIDE_ME_AUTH_POLL_INTERVAL=2                         # Seconds between auth checks
HIDE_ME_DEFAULT_PROFILE=default                      # Default profile name
```
...
- **Headless mode**: Set `HIDE_ME_HEADLESS=false` to see the browser (useful for debugging)
...
export HIDE_ME_HEADLESS=false
hide-me search query "test"
```
