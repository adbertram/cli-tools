"""TutorialsDojo client using shared browser session tooling."""
...
class TutorialsDojoClient:
    ...
    def search(
        ...
        If the site only renders data after JavaScript:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement search for TutorialsDojo")
    ...
    def get_item(self, item_id: str) -> ItemDetail:
        ...
        """
        raise NotImplementedError("Implement get_item for TutorialsDojo")
    ...
    def list_items(
        ...
        TODO: Implement for your site. Prefer direct HTTP:
            ...
            return [create_item(d) for d in raw[:limit]]
        """
        raise NotImplementedError("Implement list_items for TutorialsDojo")


_client: Optional[TutorialsDojoClient] = None


def get_client() -> TutorialsDojoClient:
    """Get or create the global TutorialsDojo client instance."""
    global _client
    if _client is None:
        _client = TutorialsDojoClient()
    return _client
